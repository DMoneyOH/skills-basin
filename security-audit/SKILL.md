...
description: >
  ...
  Covers: security audit, security auditor, cc skill security review, codebase audit pre push, skill security auditor.
  Use for any task involving security audit, security auditor, cc skill security review, codebase audit pre push, skill security auditor.
merged_from:
  - security-auditor
